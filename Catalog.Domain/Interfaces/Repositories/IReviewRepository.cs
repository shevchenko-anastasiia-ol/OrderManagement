...
public interface IReviewRepository : IGenericRepository<Review>
{
    ...
    Task<PagedList<Review>> GetByCursorAsync(string? cursor, int pageSize, string? productId = null, string? orderBy = null, CancellationToken cancellationToken = default);

...
public interface IProductRepository : IGenericRepository<Product>
{
    ...
    Task<IEnumerable<Product>> GetProductsSortedByPriceAsync( int pageNumber, int pageSize, bool ascending = true, CancellationToken cancellationToken = default);
    Task<IEnumerable<Product>> GetProductsSortedByNameAsync(int pageNumber, int pageSize, bool ascending = true, CancellationToken cancellationToken = default);
    Task<PagedList<Product>> GetProductsByCursorAsync(string? cursor, int pageSize, string? orderBy = null, CancellationToken cancellationToken = default);
}